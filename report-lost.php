...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Remove username from insert if not in table
    $stmt = $conn->prepare("INSERT INTO lost_items (item_name, date_lost, location, description, image) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $item_name, $date_lost, $location, $description, $imageName);
